...
if __name__ == "__main__":
	...
	os.system(
		f"gst-launch-1.0 -vvv udpsrc port={port} ! application/x-rtp,encoding-name=H264,payload=96 ! rtph264depay ! queue ! avdec_h264 {'! videoflip method=vertical-flip ' if flip else ''}! autovideosink sync=false -e"
	)
